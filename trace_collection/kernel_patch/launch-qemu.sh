...
TMP2="../$EXEC_PATH/bin/qemu-system-x86_64"
QEMU_EXE="$(readlink -e $TMP2)"
[ -z "$QEMU_EXE" ] && {
...
add_opts "-d int,trace:socket_listen,trace:kvm_ioctl,trace:kvm_device_ioctl"
#trace:kvm_vm_ioctl,kvm_vcpu_ioctl
